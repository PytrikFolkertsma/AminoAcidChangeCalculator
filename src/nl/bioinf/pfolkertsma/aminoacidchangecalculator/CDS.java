...
public class CDS {
    ...
    protected static HashMap <String, String> cds = new HashMap();
    
    protected void readFastaFile(){
        Path path = Paths.get("/commons/student/2014-2015/Thema11/NGnodde/PotatoGenome/PGSC_DM_v3.4_cds.fasta"); 
    ...
    protected void createCdsHashmap(){
        IntStream.range(0, descriptions.length).forEach(
            n -> {
                cds.put(descriptions[n].substring(1), sequences[n]);
            }
        );
    }
}
